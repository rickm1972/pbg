...
export const SCORED_QUESTIONS: QuizScoredQuestion[] = [
  { id: 'q1', text: 'Do you use a nonstick frying pan?', deductionIfYes: 10 },
  {
    id: 'q2',
    text: 'Do you use a plastic, plastic-lined, or plastic-topped water bottle?',
    deductionIfYes: 5,
  },
  { id: 'q3', text: 'Do you use plastic or nylon cooking utensils?', deductionIfYes: 3 },
  { id: 'q4', text: 'Do you use cling wrap on food?', deductionIfYes: 7 },
  { id: 'q5', text: 'Do you use a plastic cutting board?', deductionIfYes: 5 },
  { id: 'q6', text: 'Do you store food in plastic containers?', deductionIfYes: 7 },
  {
    id: 'q7',
    text: 'Do you use a drip coffee maker or pod machine with plastic parts?',
    deductionIfYes: 3,
  },
  { id: 'q8', text: 'Do you use nonstick baking sheets or bakeware?', deductionIfYes: 7 },
  {
    id: 'q9',
    text: 'Do you use a plastic or plastic-lined electric kettle?',
    deductionIfYes: 3,
  },
  { id: 'q10', text: 'Do you microwave food in plastic containers?', deductionIfYes: 10 },
  { id: 'q11', text: 'Do you wash plastic items in the dishwasher?', deductionIfYes: 5 },
  { id: 'q12', text: 'Do you use laundry or dishwasher pods?', deductionIfYes: 3 },
  {
    id: 'q13',
    text: 'Do you drink from disposable plastic-lined cups (paper coffee cups, plastic iced coffee cups, plastic water bottles)?',
    deductionIfYes: 10,
  },
  { id: 'q14', text: 'Do you eat takeout from plastic containers?', deductionIfYes: 5 },
]

export const AWARENESS_QUESTIONS: QuizAwarenessQuestion[] = [
  {
    id: 'q15',
    text: 'Did you know that some chemicals found in nonstick cookware have been linked to cancer, thyroid problems, and weakened immune systems?',
  },
  {
    id: 'q16',
  ...
  {
    id: 'q17',
    text: 'Did you know that heat — like microwaving, dishwashers, or hot food — makes plastic release more chemicals into your food and drinks?',
  },
]
...
export const BRIDGE_SENTENCE =
  'Your kitchen score reflects your current habits and items. Every PAC Safety Score on PlasticBegone uses the same 0-100 scale — swap in higher-scoring products and watch your kitchen score rise.'

export const INTERSTITIAL_AFTER_Q9 =
  "Heat amplifies migration — even 'microwave-safe' plastic releases more chemicals when warmed."
