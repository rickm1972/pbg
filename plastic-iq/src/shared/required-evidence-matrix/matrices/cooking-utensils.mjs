...
export const COOKING_UTENSILS_MATRIX = {
  subcategory_key: 'cooking_utensils',
  display_label: 'Cooking utensils',
  ...
  material_component_fields: [
    {
      ...
      label: 'Food-contact material (raw)',
    ...
    },
    {
      ...
      label: 'Handles / coatings on utensil',
      category: 'material_component',
  ...
  external_checks: [
    ...
    },
    {
      ...
      label: 'Plastic / nylon food-contact disclosure',
      category: 'external_check',
    ...
    },
    {
      ...
      label: 'Silicone utensil grade disclosure',
      category: 'external_check',
    ...
    },
    {
      ...
      label: 'Proprietary / undisclosed coating flagged',
      category: 'external_check',
