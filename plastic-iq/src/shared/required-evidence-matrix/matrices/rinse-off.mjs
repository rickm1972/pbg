...
export const RINSE_OFF_MATRIX = {
  subcategory_key: 'rinse_off',
  display_label: 'Rinse-off personal care',
  ...
  material_component_fields: [
    {
      ...
      label: 'Primary formulation / packaging material (raw)',
  ...
  optional_fields: [],
  non_score_fields: ['ingredient_list', 'care_and_use_instructions'],
  external_checks: [
    {
