import { isMalformedOrSpamUrl, isPlaceholderClaim, normalizeSourceUrl } from '../persona/url-guard.mjs'
 ...
 */
export function buildChannelSourcesFromCitations(catalog, citationsUsed) {
  const out = []
  const seen = new Set()
